...
import com.playphone.sdk3sample.util.IabHelper;
import com.playphone.sdk3sample.util.IabResult;
import com.playphone.sdk3sample.util.Inventory;
import com.playphone.sdk3sample.util.Purchase;
 ...
 *
 * All the game-specific logic is implemented here in BillingActivity, while the
 ...
 */
public class BillingActivity extends PSGNTrackingActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean useGooglePlay = getIntent().getBooleanExtra("USE_GOOGLE_PLAY", false);
        ...
        if (useGooglePlay) {
            base64EncodedPublicKey = "CONSTRUCT_YOUR_GOOGLE_PLAY_KEY_AND_PLACE_IT_HERE";
        } else {
            /*
             * You can get your Playphone application public key from Game Details page
             * at Playphone Developer Portal under "License Key for ZDK"
             * https://developer.playphone.com/games
             */
        ...
        if (getPackageName().startsWith("com.playphone")) {
            throw new RuntimeException("Please change the sample's package name! See README.");
        }

        // Create the helper, passing it our context and the public key to verify signatures with
        Log.d(TAG, "Creating IAB helper.");
        mHelper = new IabHelper(this, base64EncodedPublicKey, useGooglePlay);
